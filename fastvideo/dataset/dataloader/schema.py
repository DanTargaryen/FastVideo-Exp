...
pyarrow_schema_ti2v_controlnet = pa.schema([
    ...
    # --- Optional cached full-length branch latents for online-warp rollout ---
    pa.field("depth_latent_bytes", pa.binary()),
    pa.field("depth_latent_shape", pa.list_(pa.int64())),
    pa.field("depth_latent_dtype", pa.string()),
    pa.field("normal_latent_bytes", pa.binary()),
    pa.field("normal_latent_shape", pa.list_(pa.int64())),
    pa.field("normal_latent_dtype", pa.string()),
    # --- Metadata ---
    pa.field("file_name", pa.string()),
    pa.field("caption", pa.string()),
    pa.field("media_type", pa.string()),
    pa.field("clip_start_global_id", pa.int64()),
    pa.field("clip_start_mode", pa.string()),
    pa.field("width", pa.int64()),
    pa.field("height", pa.int64()),
    pa.field("num_frames", pa.int64()),
    pa.field("duration_sec", pa.float64()),
