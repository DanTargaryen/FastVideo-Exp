...
CONFIG_PATH="${CONFIG_PATH:-configs/train_wan_controlnet_self_forcing_phase3_rgbn_bidirectional_teacherinit.yaml}"
OUTPUT_DIR="${OUTPUT_DIR:-/vePFS-buaa/linming/workspace/worldrender/phase3_dmd_out_rgbn81_bidirectional_teacherinit}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-phase3_dmd_rgbn81_bidirectional_teacherinit_lr2e6_f4e7_ga6}"
