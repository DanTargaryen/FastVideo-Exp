...
CONFIG_PATH="${CONFIG_PATH:-configs/train_wan_controlnet_self_forcing_phase3_mc401_cachedctrl_ablation50.yaml}"
OUTPUT_DIR="${OUTPUT_DIR:-/vePFS-buaa/linming/workspace/worldrender/phase3_dmd_out_causal_lr_ga6_mc401_cachedctrl_ablation50_pctl}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-phase3_dmd_from_phase2ode_ckpt3000_lr2e6_f4e7_ga6_mc401_cachedctrl_ablation50_pctl}"
